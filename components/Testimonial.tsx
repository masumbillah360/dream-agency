      ...
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-semibold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl">
            Do not just take our words. Over 1000+ people trust us.
          </h2>
        </div>
        ...
        <div className="grid max-w-md grid-cols-1 gap-5 mx-auto mt-12 sm:mt-16 lg:grid-cols-3 lg:max-w-none">
          ...
          <div className="bg-gray-100 rounded-2xl xl:rotate-2">
            <div className="p-8">
              <blockquote>
                <p className="text-xl font-medium leading-9 text-gray-900">
                  I did not know designing in Figma could be this individualized. I had never considered it before, but
                  Landingfolio changed
                  my mind.
                </p>
              </blockquote>
              <p className="mt-6 text-base font-semibold text-gray-900">
          ...
          <div className="bg-gray-100 rounded-2xl xl:-rotate-2">
            <div className="p-8">
              <blockquote>
                <p className="text-xl font-medium leading-9 text-gray-900">
                  We love ! Our designers were using it for their projects, so clients already knew what was and how to use it
                </p>
              </blockquote>
              <p className="mt-6 text-base font-semibold text-gray-900">
                Jenny Wilson
