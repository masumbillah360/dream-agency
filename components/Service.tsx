...
import { IoBugOutline, IoChatbubblesOutline } from "react-icons/io5";
import { LuPackageCheck, LuScreenShare } from "react-icons/lu";
import { RiSecurePaymentLine } from "react-icons/ri";

const Service = () => {
  return (
    <section className="pb-10 bg-white sm:py-16 lg:py-24 w-full mx-auto">
      {/* Title */}
      <div>
      <h2 className="text-3xl font-semibold tracking-tight text-gray-900 sm:text-4xl lg:text-5xl text-center pb-14">
          What we do for{" "}
        </h2>
      </div>
        ...
        <div className="grid grid-cols-1 gap-12 text-center sm:grid-cols-2 md:grid-cols-3 lg:gap-y-16">
          ...
          <div>
            <div className="relative flex items-center justify-center mx-auto">
              ...
              <div
                className="absolute right-[166px] top-[24px] text-blue-600 w-9 h-9"
                fill="currentColor"
                viewBox="0 0 24 24"
                stroke="currentColor"
              >
          ...
          <div>
            <div className="relative flex items-center justify-center mx-auto">
              ...
              <div className="absolute right-[166px] top-[20px] text-orange-600 w-9 h-9">
                <IoBugOutline
                  className="text-2xl text-center"
                  strokeLinecap="round"
                  strokeLinejoin="round"
          ...
          <div>
            <div className="relative flex items-center justify-center mx-auto">
              ...
              <div className="absolute right-[166px] top-[20px] text-green-600 w-9 h-9">
          ...
          <div>
            <div className="relative flex items-center justify-center mx-auto">
              ...
              <div className="absolute right-[166px] top-[20px] text-purple-600 w-9 h-9">
                <LuPackageCheck
                  className="text-2xl text-center"
                  strokeLinecap="round"
                  strokeLinejoin="round"
          ...
          {/* Live Screen Sharing for Real-Time Assistance */}
          <div>
            <div className="relative flex items-center justify-center mx-auto">
              <svg
              ...
              <div className="absolute right-[166px] top-[20px] text-gray-600 w-9 h-9">
                <LuScreenShare
                  className="text-2xl text-center"
                  strokeLinecap="round"
                  strokeLinejoin="round"
          ...
          <div>
            <div className="relative flex items-center justify-center mx-auto">
              ...
              <div className="absolute right-[166px] top-[30px] text-lime-600 w-9 h-9">
                <RiSecurePaymentLine
                  className="text-2xl text-center"
                  strokeLinecap="round"
                  strokeLinejoin="round"
